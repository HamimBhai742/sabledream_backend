...
const serviceAccount = {
  ...
  client_x509_cert_url:
    "https://www.googleapis.com/robot/v1/metadata/x509/firebase-adminsdk-fbsvc%40sable-dreams.iam.gserviceaccount.com",
